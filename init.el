...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(gnu-elpa-keyring-update yaml-mode writeroom-mode use-package smex smart-mode-line scss-mode rainbow-delimiters projectile prodigy paredit pallet markdown-mode magit lv js2-mode idle-highlight-mode helm-dash graphql go-mode git-timemachine flycheck-cask expand-region exec-path-from-shell emmet-mode company cider))))
(custom-set-faces
